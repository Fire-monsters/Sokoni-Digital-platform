    ...
    <AppScreen scroll>
      ...
      <View style={styles.sections}>
        <InfoCard
          ...
          description="Administrators must provide a reason when rejecting a rider application."
        />
        <InfoCard
          title="Operational access locked"
          description="Delivery offers, trips and rider tools remain unavailable for rejected accounts."
        />
        <InfoCard
          title="Next steps"
