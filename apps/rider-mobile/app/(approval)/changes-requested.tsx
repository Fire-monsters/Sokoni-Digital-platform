...
export default function RiderChangesRequestedScreen() {
  return (
    <AppScreen scroll>
      <View style={styles.header}>
        ...
        <AppText color="secondary" variant="bodyLarge">
          The operations team needs a few changes before your rider account can be approved.
        </AppText>
      </View>
      ...
      <View style={styles.sections}>
        <InfoCard
          ...
          description="Check the administrator notes and update only the requested motorcycle, association or verification details."
        />
        <InfoCard
