    ...
    <AppScreen scroll>
      <View style={styles.header}>
        ...
        <AppText color="secondary" variant="bodyLarge">
          Rider operations are temporarily disabled while E-Katale reviews this account.
        </AppText>
      </View>
      ...
      <View style={styles.sections}>
        <InfoCard
          title="Access paused"
          description="Delivery offers, trips and profile changes remain locked until the suspension is resolved."
        />
        <InfoCard
