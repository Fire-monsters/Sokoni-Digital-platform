...
export default function VendorVerifyRecoveryOtpScreen() {
    ...
    <AppScreen>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.notice}>
            <AppText color="secondary" variant="caption">
              Codes expire after a short time. Invalid, expired and resend cooldown states will be connected through the backend slice.
            </AppText>
          </View>
        </View>
      </View>
      ...
      <View style={styles.actions}>
        ...
        <AppButton
          label="Resend code"
          onPress={() => {
            Alert.alert('Resend code', 'Recovery OTP resend cooldown will be connected with the backend OTP service.');
          }}
          variant="secondary"
        />
        <AppButton
