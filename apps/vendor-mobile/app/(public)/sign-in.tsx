      ...
      <View style={styles.content}>
        <View style={styles.copy}>
          ...
          <AppText color="secondary" variant="bodyLarge">
            Sign in with your verified vendor phone number and password.
          </AppText>
        </View>

        <View style={styles.notice}>
          <AppText color="secondary">
            Password sign-in will connect to Supabase Auth in the next vendor authentication slice.
          </AppText>
        </View>
      </View>
